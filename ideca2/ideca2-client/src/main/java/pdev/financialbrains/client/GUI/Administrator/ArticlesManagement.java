...
public class ArticlesManagement extends JFrame {
	...
	public ArticlesManagement() {
				...
				.setHorizontalGroup(
						gl_panel_4.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_panel_4.createSequentialGroup().addGap(7)
										.addComponent(scrollPane, GroupLayout.PREFERRED_SIZE, 451,
												GroupLayout.PREFERRED_SIZE)
										.addGap(17).addComponent(panel_5, GroupLayout.PREFERRED_SIZE, 433,
												GroupLayout.PREFERRED_SIZE)
				...
				.setVerticalGroup(gl_panel_4.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel_4.createSequentialGroup().addGap(13)
								.addGroup(gl_panel_4.createParallelGroup(Alignment.LEADING)
										.addComponent(scrollPane, GroupLayout.PREFERRED_SIZE, 397,
												GroupLayout.PREFERRED_SIZE)
		...
		delete.setIcon(new ImageIcon(
				ArticlesManagement.class.getResource("/pdev/financialbrains/client/pictures/delete.png")));
		...
		update.setIcon(
				new ImageIcon(ArticlesManagement.class.getResource("/pdev/financialbrains/client/pictures/add.png")));
		...
		background.setIcon(new ImageIcon(
				ArticlesManagement.class.getResource("/pdev/financialbrains/client/pictures/backAdminGrand2.PNG")));
	...
	protected void initDataBindings() {
		JTableBinding<Article, List<Article>, JTable> jTableBinding = SwingBindings
				.createJTableBinding(UpdateStrategy.READ, articles, table);
		//
