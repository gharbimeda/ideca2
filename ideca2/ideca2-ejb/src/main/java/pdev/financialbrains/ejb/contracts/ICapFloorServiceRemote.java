...
public interface ICapFloorServiceRemote {
	...
	double pricingCapFloor(Float amount,String cap_floor, Integer nDays, Integer period, Integer daysYear, Double f_rate, Float strike, Float vol, Double maturity, Integer rfr);
